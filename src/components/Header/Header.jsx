            ...
            <header className="header">
                ...
                <div className="searchbox">
                    <form action className="searchbox-form" onSubmit={handleSubmit} onReset={handleReset} noValidate>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 18 18" aria-hidden="true"><g fill="none" fillRule="evenodd" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.67" transform="translate(1 1)"><circle cx="7.11" cy="7.11" r="7.11"></circle><path d="M16 16l-3.87-3.87"></path></g></svg>
                        </button>
                        <button className={`searchbox-reset ${searchQuery.length > 0 ? '' : 'hidden'}`} type="reset" title="Clear the search query"><svg className="ais-SearchBox-resetIcon" viewBox="0 0 20 20" width="10" height="10" aria-hidden="true"><path d="M8.114 10L.944 2.83 0 1.885 1.886 0l.943.943L10 8.113l7.17-7.17.944-.943L20 1.886l-.943.943-7.17 7.17 7.17 7.17.943.944L18.114 20l-.943-.943-7.17-7.17-7.17 7.17-.944.943L0 18.114l.943-.943L8.113 10z"></path></svg></button>
                        <span className={`searchbox-loadingIndicator ${isLoading && searchQuery ? '' : 'hidden'}`} hidden>
                            <svg width="16" height="16" viewBox="0 0 38 38" stroke="#444" className="ais-SearchBox-loadingIcon" aria-hidden="true">
